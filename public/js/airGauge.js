function AirGauge(placeholderName, configuration)
{
    ...
    this.render = function()
    {
        ...
        for (var index in this.config.darkBlueZones)
        {
            this.drawBand(this.config.darkBlueZones[index].from, this.config.darkBlueZones[index].to, self.config.darkBlueColor);
        }
